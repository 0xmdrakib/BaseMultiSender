...
export function Badge({ className, tone = "neutral", ...props }: React.HTMLAttributes<HTMLSpanElement> & {
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-medium shadow-[0_8px_18px_rgba(15,23,42,0.035),inset_0_1px_0_rgba(255,255,255,0.82)] backdrop-blur-xl",
        tones[tone],
        className
      )}
      {...props}
